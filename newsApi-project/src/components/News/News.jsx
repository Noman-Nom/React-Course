    ...
    useEffect(() => {
        const searchNews = async () => {
            try {
                ...
                const response = await fetch(`https://newsapi.org/v2/everything?q=apple&from=2023-08-18&sortBy=publishedAt&catogery=${catogery}&pageSize=${pageSize}&apiKey=${ApiKey}`)
